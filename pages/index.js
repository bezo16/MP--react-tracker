...
export default function Home() {
  ...
  useEffect(() => {
    ...
    setRunSteps(Number(localStorage.getItem('run')))
  ...
  useEffect(() => {
    setCalories(Math.floor(steps / 33) + Math.floor(runSteps / 20) + Math.floor(jumps / 5))
  },[steps,jumps,runSteps])
      ...
      <div className={registered ? '' : 'hiden'}>
        ...
        <section className="overview">
          <div className="overview-card">
            ...
            <p className="overview-card__count">{steps + runSteps} steps</p>
          </div>
          <div className="overview-card">
            <h3 className="overview-card__title">
            Jumping-Rope
